...
namespace Box2D.XNA
{
    ...
    {
        /// <summary> The collision category bits. Normally you would just set one bit.
        /// </summary>
    ...
    {
	    /// <summary> The constructor sets the default fixture definition values.
        /// </summary>
        public FixtureDef()
	    {
		    shape = null;
	    ...
	    /// <summary> Use this to store application specific fixture data.
        /// </summary>
        public object userData;

	    /// <summary> The friction coefficient, usually in the range [0,1].
        /// </summary>
        public float friction;

	    /// <summary> The restitution (elasticity) usually in the range [0,1].
        /// </summary>
	    ...
	    /// <summary> Contact filtering data.
        /// </summary>
    ...
    /// </summary> <warning> you cannot reuse fixtures.
    /// </warning>
    public class Fixture
    {
	    ...
	    /// <summary> Get the child Shape. You can modify the child Shape, however you should not change the
	    ...
	    /// </summary> <return> the true if the Shape is a sensor.
	    /// </returns>
	    public bool IsSensor()
        {
            return _isSensor;
	    ...
	    /// </summary> <return> the parent body.
	    /// </returns>
	    public Body GetBody()
        {
            return _body;
	    ...
	    /// <summary> Test a point for containment in this fixture.
	    ...
	    /// <summary> Get the mass data for this fixture. The mass data is based on the density and
	    ...
	    /// <summary> Set the coefficient of friction.
	    /// </summary>
	    ...
	    /// <summary> Set the coefficient of restitution.
	    /// </summary>
        ...
        /// <summary> Get the fixture's AABB. This AABB may be enlarge and/or stale.
