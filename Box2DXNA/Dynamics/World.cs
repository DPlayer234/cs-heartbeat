...
namespace Box2D.XNA
{
    ...
    public class World
    {
        /// <summary> ruct a world object.
        /// </summary> <param name="gravity"> the world gravity vector.
        /// </param> <param name="doSleep"> improve performance by not simulating inactive bodies.
        /// </param>
	    ...
	    /// <summary> Register a destruction listener.
	    /// </summary>
	    ...
	    /// <summary> Register a contact event listener
	    /// </summary>
	    ...
	    /// <summary> Create a rigid body given a definition. No reference to the definition
	    /// is retained.
	    ...
	    /// and raint solution.
	    /// </summary> <param name="timeStep"> the amount of time to simulate, this should not vary.
	    /// </param> <param name="velocityIterations"> for the velocity raint solver.
	    /// </param> <param name="positionIterations"> for the position raint solver.
	    /// </param>
        ...
        /// <summary> Call this after you are done with time steps to clear the forces. You normally
	    /// call this after each call to Step, unless you are performing sub-steps. By default,
	    /// forces will be automatically cleared, so you don't need to call this function.
	    /// </summary> <see> SetAutoClearForces
        /// </see>
        ...
        /// <summary> Get the contact manager for testing.
        /// </summary>
        ...
        /// <summary> Ray-cast the world for all fixtures in the path of the ray. Your callback
	    /// controls whether you get the closest point, any point, or n-points.
	    /// The ray-cast ignores shapes that contain the starting point.
	    /// </summary> <param name="callback"> a user implemented callback class.
	    /// </param> <param name="point1"> the ray starting point
	    /// </param> <param name="point2"> the ray ending point
        /// </param>
	    ...
	    /// </summary> <return> the head of the world body list.
	    /// </returns>
	    ...
	    /// <summary> Get the world joint list. With the returned joint, use Joint.GetNext to get
	    /// the next joint in the world list. A null joint indicates the end of the list.
	    /// </summary> <return> the head of the world joint list.
	    /// </returns>
	    ...
	    /// <summary> Get the world contact list. With the returned contact, use Contact.GetNext to get
	    /// the next contact in the world list. A null contact indicates the end of the list.
	    /// </summary> <return> the head of the world contact list.
	    /// </returns> <warning> contacts are 
	    /// </warning>
