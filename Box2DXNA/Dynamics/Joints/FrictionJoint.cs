...
namespace Box2D.XNA
{
    /// <summary> Friction joint definition.
    /// </summary>
    public class FrictionJointDef : JointDef
    {
        ...
        /// <summary> The maximum friction force in N.
	    /// </summary>
	    public float maxForce;

        /// <summary> The maximum friction torque in N-m.
	    /// </summary>
	    public float maxTorque;
    };

    /// <summary> Friction joint. This is used for top-down friction.
