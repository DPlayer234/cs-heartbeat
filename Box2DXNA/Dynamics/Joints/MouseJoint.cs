...
namespace Box2D.XNA
{
/// <summary> Mouse joint definition. This requires a world target point,
...
public class MouseJointDef : JointDef
{
	...
	/// <summary> The initial world target point. This is assumed
	/// to coincide with the body anchor initially.
	/// </summary>
	public Vector2 target;

	/// <summary> The maximum constraint force that can be exerted
	/// to move the candidate body. Usually you will express
	/// as some multiple of the weight (multiplier * mass * gravity).
	/// </summary>
	public float maxForce;

	/// <summary> The response speed.
	/// </summary>
	public float frequencyHz;

	/// <summary> The damping ratio. 0 = no damping, 1 = critical damping.
	/// </summary>
	public float dampingRatio;
};

/// <summary> A mouse joint is used to make a point on a body track a
...
public class MouseJoint : Joint
{
	...
	/// <summary> Use this to update the target point.
	/// </summary>
	public void SetTarget(Vector2 target)
    {
	    ...
	    /// <summary> Set/get the maximum force in Newtons.
	    /// </summary>
	    ...
	    /// <summary> Set/get the frequency in Hertz.
	    /// </summary>
	    ...
	    /// <summary> Set/get the damping ratio (dimensionless).
	    /// </summary>
