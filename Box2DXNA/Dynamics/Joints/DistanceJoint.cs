...
namespace Box2D.XNA
{
    ...
    /// </summary> <warning> Do not use a zero or short length.
    /// </warning>
...
/// </summary>
        ...
        /// <summary> The natural length between the anchor points.
	    /// </summary>
	    public float length;

        /// <summary> The mass-spring-damper frequency in Hertz.
	    /// </summary>
    ...
    /// <summary> A distance joint rains two points on two bodies
    /// to remain at a fixed distance from each other. You can view
    /// this as a massless, rigid rod.
    /// </summary>
    public class DistanceJoint : Joint
    {
        /// <summary> Set/get the natural length.
