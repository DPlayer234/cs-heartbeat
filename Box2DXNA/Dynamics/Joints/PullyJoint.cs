...
namespace Box2D.XNA
{
    /// <summary> Pulley joint definition. This requires two ground anchors,
    ...
    public class PulleyJointDef : JointDef
    {
	    ...
	    /// <summary> Initialize the bodies, anchors, lengths, max lengths, and ratio using the world anchors.
        /// </summary>
	    ...
	    /// <summary> The first ground anchor in world coordinates. This point never moves.
	    /// </summary>
	    ...
	    /// <summary> The a reference length for the segment attached to body1.
	    /// </summary>
	    public float lengthA;

	    /// <summary> The maximum length of the segment attached to body1.
	    /// </summary>
	    public float maxLengthA;

	    /// <summary> The a reference length for the segment attached to body2.
	    /// </summary>
	    public float lengthB;

	    /// <summary> The maximum length of the segment attached to body2.
	    /// </summary>
	    public float maxLengthB;

	    /// <summary> The pulley ratio, used to simulate a block-and-tackle.
	    /// </summary>
	    public float ratio;
    };
    ...
    public class PulleyJoint : Joint
    {
	    ...
	    /// <summary> Get the first ground anchor.
	    /// </summary>
	    ...
	    /// <summary> Get the second ground anchor.
	    /// </summary>
	    ...
	    /// <summary> Get the current length of the segment attached to body1.
	    /// </summary>
	    ...
	    /// <summary> Get the current length of the segment attached to body2.
	    /// </summary>
