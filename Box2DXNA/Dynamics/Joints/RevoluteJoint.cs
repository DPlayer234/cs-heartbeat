...
namespace Box2D.XNA
{
    ...
    public class RevoluteJointDef : JointDef
    {
	    ...
	    /// <summary> The local anchor point relative to body1's origin.
	    /// </summary>
	    public Vector2 localAnchorA;

	    /// <summary> The local anchor point relative to body2's origin.
	    /// </summary>
	    public Vector2 localAnchorB;

	    /// <summary> The body2 angle minus body1 angle in the reference state (radians).
	    /// </summary>
	    public float referenceAngle;

	    /// <summary> A flag to enable joint limits.
	    /// </summary>
	    public bool enableLimit;

	    /// <summary> The lower angle for the joint limit (radians).
	    /// </summary>
	    public float lowerAngle;

	    /// <summary> The upper angle for the joint limit (radians).
	    /// </summary>
	    public float upperAngle;

	    /// <summary> A flag to enable the joint motor.
	    /// </summary>
	    public bool enableMotor;

	    /// <summary> The desired motor speed. Usually in radians per second.
	    /// </summary>
    ...
    /// <summary> A revolute joint rains to bodies to share a common point while they
    ...
    public class RevoluteJoint : Joint
    {
	    ...
	    /// <summary> Get the current joint angle in radians.
	    /// </summary>
	    ...
	    /// <summary> Get the current joint angle speed in radians per second.
	    /// </summary>
	    ...
	    /// <summary> Get the lower joint limit in radians.
	    /// </summary>
	    ...
	    /// <summary> Get the upper joint limit in radians.
	    /// </summary>
	    ...
	    /// <summary> Set the joint limits in radians.
	    /// </summary>
	    ...
	    /// <summary> Is the joint motor enabled?
	    /// </summary>
	    ...
	    /// <summary> Enable/disable the joint motor.
	    /// </summary>
	    ...
	    /// <summary> Set the motor speed in radians per second.
	    /// </summary>
	    ...
	    /// <summary> Get the motor speed in radians per second.
	    /// </summary>
	    ...
	    /// <summary> Set the maximum motor torque, usually in N-m.
	    /// </summary>
	    ...
	    /// <summary> Get the current motor torque, usually in N-m.
	    /// </summary>
