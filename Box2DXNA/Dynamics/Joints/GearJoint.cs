...
namespace Box2D.XNA
{
    ...
    public class GearJointDef : JointDef
    {
	    ...
	    /// <summary> The first revolute/prismatic joint attached to the gear joint.
	    /// </summary>
	    public Joint joint1;

	    /// <summary> The second revolute/prismatic joint attached to the gear joint.
	    /// </summary>
	    public Joint joint2;

	    /// <summary> The gear ratio.
	    /// </summary> <see> GearJoint for explanation.
	    /// </see>
	    public float ratio;
    };

    /// <summary> A gear joint is used to connect two joints together. Either joint
    ...
    /// </summary> <warning> The revolute and prismatic joints must be attached to
