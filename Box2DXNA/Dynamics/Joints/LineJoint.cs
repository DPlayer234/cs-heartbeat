...
namespace Box2D.XNA
{
    /// <summary> Line joint definition. This requires defining a line of
    ...
    public class LineJointDef : JointDef
    {
	    ...
	    /// <summary> The local translation axis in body1.
	    /// </summary>
	    ...
	    /// <summary> The lower translation limit, usually in meters.
	    /// </summary>
	    public float lowerTranslation;

	    /// <summary> The upper translation limit, usually in meters.
	    /// </summary>
	    ...
	    /// <summary> The desired motor speed in radians per second.
	    /// </summary>
	    public float motorSpeed;
    };

    /// <summary> A line joint. This joint provides two degrees of freedom: translation
    ...
    public class LineJoint : Joint
    {
	    ...
	    /// <summary> Get the current joint translation speed, usually in meters per second.
	    /// </summary>
	    ...
	    /// <summary> Get the lower joint limit, usually in meters.
	    /// </summary>
	    ...
	    /// <summary> Get the upper joint limit, usually in meters.
	    /// </summary>
	    ...
	    /// <summary> Set the joint limits, usually in meters.
	    /// </summary>
	    ...
	    /// <summary> Set the motor speed, usually in meters per second.
	    /// </summary>
	    ...
	    /// <summary> Get the motor speed, usually in meters per second.
	    /// </summary>
	    ...
	    /// <summary> Set the maximum motor force, usually in N.
	    /// </summary>
	    ...
	    /// <summary> Get the current motor force, usually in N.
	    /// </summary>
