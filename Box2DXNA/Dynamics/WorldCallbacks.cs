...
namespace Box2D.XNA
{
    ...
    /// </summary> <param name="fixture"> the fixture hit by the ray
    /// </param> <param name="point"> the point of initial intersection
    /// </param> <param name="normal"> the normal vector at the point of intersection
    /// </param> <return> -1 to filter, 0 to terminate, fraction to clip the ray for
    ...
    /// <summary> Implement and register this class with a World to provide debug drawing of physics
    ...
    public abstract class DebugDraw
    {
	    ...
	    /// <summary> Append flags to the current flags.
	    /// </summary>
	    ...
	    /// <summary> Clear flags from the current flags.
	    /// </summary>
	    ...
	    /// <summary> Draw a closed polygon provided in CCW order.
	    /// </summary>
	    public abstract void DrawPolygon(ref FixedArray8<Vector2> vertices, int count, Color color);

	    /// <summary> Draw a solid closed polygon provided in CCW order.
        /// </summary>
	    ...
	    /// <summary> Draw a transform. Choose your own length scale.
	    /// </summary> <param name="xf"> a transform.
        /// </param>
