...
namespace Box2D.XNA
{
    ...
    {
        /// <summary> This constructor sets the body definition default values.
        /// </summary>
        public BodyDef()
        {
            userData = null;
        ...
        /// <summary> The world angle of the body in radians.
        /// </summary>
        public float angle;

        /// <summary> The linear velocity of the body's origin in world co-ordinates.
        /// </summary>
        public Vector2 linearVelocity;

        /// <summary> The angular velocity of the body.
        /// </summary>
        ...
        /// <summary> Is this body awake or sleeping?
        /// </summary>
        public bool awake;

        /// <summary> Should this body be prevented from rotating? Useful for characters.
        /// </summary>
        ...
        /// </summary> <warning> You should use this flag sparingly since it increases processing time.
        /// </warning>
        public bool bullet;

        /// <summary> Does this body start out active?
	    /// </summary>
	    public bool active;

        /// <summary> Use this to store application specific body data.
        /// </summary>
        public object userData;

        /// <summary> Experimental: scales the inertia tensor.
        /// </summary>
    ...
    public class Body
    {
	    ...
	    /// <summary> Get the type of this body.
        /// </summary>
	    ...
	    /// <summary> Creates a fixture and attach it to this body. Use this function if you need
	    /// to set some fixture parameters, like friction. Otherwise you can create the
	    /// fixture directly from a shape.
	    /// If the density is non-zero, this function automatically updates the mass of the body.
	    /// Contacts are not created until the next time step.
	    /// </summary> <param name="def"> the fixture definition.
	    /// </param> <warning> This function is locked during callbacks.
	    /// </warning>
	    ...
	    /// <summary> Creates a fixture from a shape and attach it to this body.
	    /// This is a convenience function. Use FixtureDef if you need to set parameters
	    /// like friction, restitution, user data, or filtering.
	    /// If the density is non-zero, this function automatically updates the mass of the body.
	    /// </summary> <param name="shape"> the shape to be cloned.
	    /// </param> <param name="density"> the shape density (set to zero for static bodies).
	    /// </param> <warning> This function is locked during callbacks.
	    /// </warning>
	    ...
	    /// </summary> <param name="fixture"> the fixture to be removed.
	    /// </param> <warning> This function is locked during callbacks.
	    /// </warning>
	    ...
	    /// <summary> Set the position of the body's origin and rotation.
	    /// This breaks any contacts and wakes the other bodies.
        /// Manipulating a body's transform may cause non-physical behavior.
	    /// </summary> <param name="position"> the world position of the body's local origin.
	    /// </param> <param name="angle"> the world rotation in radians.
	    /// </param>
	    ...
	    /// </summary> <return> the world transform of the body's origin.
	    /// </returns>
	    ...
	    /// <summary> Get the world body origin position.
	    /// </summary> <return> the world position of the body's origin.
	    /// </returns>
	    ...
	    /// </summary> <return> the current world rotation angle in radians.
	    /// </returns>
	    ...
	    /// <summary> Get the world position of the center of mass.
	    /// </summary>
	    ...
	    /// <summary> Get the local position of the center of mass.
	    /// </summary>
	    ...
	    /// </summary> <param name="v"> the new linear velocity of the center of mass.
	    /// </param>
	    ...
	    /// <summary> Get the linear velocity of the center of mass.
	    /// </summary> <return> the linear velocity of the center of mass.
	    /// </returns>
	    ...
	    /// </summary> <param name="omega"> the new angular velocity in radians/second.
	    /// </param>
	    ...
	    /// </summary> <return> the angular velocity in radians/second.
	    /// </returns>
	    ...
	    /// </summary> <param name="force"> the world force vector, usually in Newtons (N).
	    /// </param> <param name="point"> the world position of the point of application.
	    /// </param>
	    ...
	    /// </summary> <param name="torque"> about the z-axis (out of the screen), usually in N-m.
	    /// </param>
	    ...
	    /// </summary> <param name="impulse"> the world impulse vector, usually in N-seconds or kg-m/s.
	    /// </param> <param name="point"> the world position of the point of application.
	    /// </param>
        ...
        /// </summary> <param name="impulse"> the angular impulse in units of kg*m*m/s  
        /// </param>
	    ...
	    /// </summary> <return> the mass, usually in kilograms (kg).
	    /// </returns>
        ...
        /// <summary> Get the rotational inertia of the body about the local origin.
	    /// </summary> <return> the rotational inertia, usually in kg-m^2.
	    /// </returns>
        ...
        /// <summary> Get the mass data of the body.
	    /// </summary> <return> a struct containing the mass, inertia and center of the body.
	    /// </returns>
        ...
        /// <summary> Set the mass properties to override the mass properties of the fixtures.
 	    /// Note that this changes the center of mass position.
        /// Note that creating or destroying fixtures can also alter the mass.
        /// This function has no effect if the body isn't dynamic.
        /// </summary> <param name="massData"> the mass properties.
        /// </param>
        ...
        /// <summary> This resets the mass properties to the sum of the mass properties of the fixtures.
	    ...
	    /// </summary> <param name="localPoint"> a point on the body measured relative the the body's origin.
	    /// </param> <return> the same point expressed in world coordinates.
	    /// </returns>
	    ...
	    /// </summary> <param name="localVector"> a vector fixed in the body.
	    /// </param> <return> the same vector expressed in world coordinates.
	    /// </returns>
	    ...
	    /// </summary> <param name="a"> point in world coordinates.
	    /// </param> <return> the corresponding local point relative to the body's origin.
	    /// </returns>
	    ...
	    /// </summary> <param name="a"> vector in world coordinates.
	    ...
	    /// </summary> <param name="a"> point in world coordinates.
	    /// </param> <return> the world velocity of a point.
	    /// </returns>
	    ...
	    /// </summary> <param name="a"> point in local coordinates.
	    /// </param> <return> the world velocity of a point.
	    /// </returns>
	    ...
	    /// <summary> Get the linear damping of the body.
	    /// </summary>
	    ...
	    /// <summary> Set the linear damping of the body.
	    /// </summary>
	    ...
	    /// <summary> Get the angular damping of the body.
	    /// </summary>
	    ...
	    /// <summary> Set the angular damping of the body.
	    /// </summary>
	    ...
	    /// <summary> Is this body treated like a bullet for continuous collision detection?
	    /// </summary>
	    ...
	    /// <summary> Should this body be treated like a bullet for continuous collision detection?
	    /// </summary>
        ...
        /// <summary> You can disable sleeping on this body. If you disable sleeping, the
	    /// body will be woken.
	    /// </summary>
	    ...
	    /// <summary> You can disable sleeping on this body.
	    /// </summary>
	    ...
	    /// <summary> Set the sleep state of the body. A sleeping body has very
	    /// low CPU cost.
	    /// </summary> <param name="flag"> set to true to put body to sleep, false to wake it.
	    /// </param>
	    ...
	    /// </summary> <return> true if the body is sleeping.
	    /// </returns>
	    public bool IsAwake()
        {
	    ...
	    /// <summary> Set the active state of the body. An inactive body is not
	    ...
	    /// <summary> Set this body to have fixed rotation. This causes the mass
	    /// to be reset.
        /// </summary>
	    ...
	    /// <summary> Get the list of all joints attached to this body.
	    /// </summary>
	    ...
	    /// </summary> <warning> this list changes during the time step and you may
        ...
        /// <summary> Get the next body in the world's body list.
	    /// </summary>
	    public Body GetNext()
        {
            return _next;
	    ...
	    /// <summary> Get the user data pointer that was provided in the body definition.
	    /// </summary>
	    ...
	    /// <summary> Get the parent world of this body.
	    /// </summary>
