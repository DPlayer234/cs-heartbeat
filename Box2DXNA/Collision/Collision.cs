...
namespace Box2D.XNA
{
    ...
    /// <summary> The features that intersect to form the contact point
    ...
    /// <summary> Contact ids to facilitate warm starting.
    /// </summary>
    ...
    /// <summary> A manifold for two touching convex Shapes.
    ...
    /// <summary> Used for computing contact manifolds.
    /// </summary>
    ...
    /// <summary> Ray-cast input data. The ray extends from p1 to p1 + maxFraction * (p2 - p1).
    /// </summary>
    ...
    /// <summary> An axis aligned bounding box.
    /// </summary>
    public struct AABB
    {
	    /// <summary> Verify that the bounds are sorted.
	    /// </summary>
	    public bool IsValid()
        {
        ...
        /// <summary> Get the perimeter length
        /// </summary>
	    ...
	    /// <summary> Combine an AABB into this one.
        /// </summary>
    ...
    public static class Collision
    {
        ...
        /// <summary> Clipping for contact manifolds.
        /// </summary>
