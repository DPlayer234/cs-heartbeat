...
namespace Box2D.XNA
{
    ...
    public class BroadPhase
    {
	    ...
	    /// <summary> Create a proxy with an initial AABB. Pairs are not reported until
	    ...
	    /// <summary> Get the AABB for a proxy.
	    /// </summary>
	    ...
	    /// <summary> Get user data from a proxy. Returns null if the id is invalid.
	    /// </summary>
        ...
        /// <summary> Test overlap of fat AABBs.
        /// </summary>
	    ...
	    /// <summary> Compute the height of the embedded tree.
	    /// </summary>
