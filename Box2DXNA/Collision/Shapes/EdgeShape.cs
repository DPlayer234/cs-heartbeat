...
/// <summary> A line segment (edge) Shape. These can be connected in chains or loops
...
namespace Box2D.XNA
{
    public class EdgeShape : Shape
    {
	    ...
	    /// <summary> Set this as an isolated edge.
	    /// </summary>
	    ...
	    /// </summary> <see> Shape::GetChildCount
        /// </see>
	    ...
	    /// <summary> These are the edge vertices
	    /// </summary>
	    public Vector2 _vertex1, _vertex2;

	    /// <summary> Optional adjacent vertices. These are used for smooth collision.
	    /// </summary>
