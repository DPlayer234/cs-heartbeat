...
namespace Box2D.XNA
{
    /// <summary> A loop Shape is a free form sequence of line segments that form a circular list.
    ...
    public class LoopShape : Shape
    {
	    ...
	    /// <summary> This always return false.
	    ...
	    /// <summary> The vertices. These are not owned/freed by the loop Shape.
	    /// </summary>
	    public Vector2[] _vertices;

	    /// <summary> The vertex count.
	    /// </summary>
	    public int _count;
