...
namespace Box2D.XNA
{
    public class PolygonShape : Shape
    {
        ...
        /// </summary> <see> b2Shape::GetChildCount
        /// </see>
	    ...
	    /// <summary> Copy vertices. This assumes the vertices define a convex polygon.
	    ...
	    /// </summary> <param name="hx"> the half-width.
	    /// </param> <param name="hy"> the half-height.
        /// </param>
	    ...
	    /// </summary> <param name="hx"> the half-width.
	    /// </param> <param name="hy"> the half-height.
	    /// </param> <param name="center"> the center of the box in local coordinates.
	    /// </param> <param name="angle"> the rotation of the box in local coordinates.
        /// </param>
