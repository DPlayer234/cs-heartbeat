...
namespace Box2D.XNA
{
    /// <summary> A dynamic AABB tree broad-phase, inspired by Nathanael Presson's btDbvt.
/// </summary>

    internal delegate float RayCastCallbackInternal(ref RayCastInput input, int userData);

    /// <summary> A node in the dynamic tree. The client does not interact with this directly.
    /// </summary>
    internal struct DynamicTreeNode
    {
        ...
        /// <summary> This is the fattened AABB.
	    /// </summary>
	    internal AABB aabb;
    ...
    /// <summary> A dynamic tree arranges data in a binary tree to accelerate
    ...
    public class DynamicTree
    {
	    ...
	    /// <summary> ructing the tree initializes the node pool.
	    /// </summary>
	    public DynamicTree()
        {
	        _root = NullNode;
	    ...
	    /// <summary> Destroy a proxy. This asserts if the id is invalid.
	    /// </summary>
        ...
        /// <summary> Move a proxy with a swepted AABB. If the proxy has moved outside of its fattened AABB,
	    /// then the proxy is removed from the tree and re-inserted. Otherwise
	    /// the function returns immediately.
        /// </summary> <return> true if the proxy was re-inserted.
	    /// </returns>
	    ...
	    /// <summary> Perform some iterations to re-balance the tree.
	    /// </summary>
	    ...
	    /// <summary> Get proxy user data.
	    /// </summary> <return> the proxy user data or 0 if the id is invalid.
	    /// </returns>
	    ...
	    /// <summary> Get the fat AABB for a proxy.
        /// </summary>
        ...
        /// <summary> Compute the height of the binary tree in O(N) time. Should not be
        /// called often.
	    /// </summary>
	    ...
	    /// </summary> <param name="input"> the ray-cast input data. The ray extends from p1 to p1 + maxFraction * (p2 - p1).
	    /// </param> <param name="callback"> a callback class that is called for each proxy that is hit by the ray.
	    /// </param>
	    ...
	    /// <summary> This is used incrementally traverse the tree for re-balancing.
	    /// </summary>
	    int _path;
