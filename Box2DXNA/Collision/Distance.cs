...
namespace Box2D.XNA
{
    /// <summary> A distance proxy is used by the GJK algorithm.
    /// It encapsulates any shape.
    /// </summary>
    public struct DistanceProxy
    {
	    /// <summary> Initialize the proxy using the given shape. The shape
	    ...
	    /// <summary> Get a vertex by index. Used by b2Distance.
	    /// </summary>
    ...
    /// <summary> Used to warm start ComputeDistance.
    ...
    /// <summary> Input for ComputeDistance.
    ...
    /// <summary> Output for ComputeDistance.
    /// </summary>
