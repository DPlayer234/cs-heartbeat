...
namespace Box2D.XNA
{
    public static class Settings
    {
        ...
        /// <summary> The maximum number of contact points between two convex shapes.
        /// </summary>
        public const int b2_maxManifoldPoints = 2;

        /// <summary> The maximum number of vertices on a convex polygon.
        /// </summary>
        ...
        /// <summary> This is used to fatten AABBs in the dynamic tree. This is used to predict
        ...
        /// <summary> A small angle used as a collision and constraint tolerance. Usually it is
        /// chosen to be numerically significant, but visually insignificant.
        /// </summary>
        public const float b2_angularSlop = (2.0f / 180.0f * b2_pi);

        /// <summary> The radius of the polygon/edge shape skin. This should not be modified. Making
        ...
        /// <summary> Maximum number of contacts to be handled to solve a TOI impact.
        /// </summary>
        public const int b2_maxTOIContacts = 32;

        /// <summary> A velocity threshold for elastic collisions. Any collision with a relative linear
        /// velocity below this threshold will be treated as inelastic.
        /// </summary>
        public const float b2_velocityThreshold = 1.0f;

        /// <summary> The maximum linear position correction used when solving constraints. This helps to
        /// prevent overshoot.
        /// </summary>
        public const float b2_maxLinearCorrection = 0.2f;

        /// <summary> The maximum angular position correction used when solving constraints. This helps to
        /// prevent overshoot.
        /// </summary>
        public const float b2_maxAngularCorrection = (8.0f / 180.0f * b2_pi);

        /// <summary> The maximum linear velocity of a body. This limit is very large and is used
        ...
        /// <summary> The maximum angular velocity of a body. This limit is very large and is used
        /// to prevent numerical problems. You shouldn't need to adjust this.
        /// </summary>
        public static float b2_maxRotation = (0.5f * b2_pi);
        public static float b2_maxRotationSquared = (b2_maxRotation * b2_maxRotation);

        /// <summary> This scale factor controls how fast overlap is resolved. Ideally this would be 1 so
        ...
        /// <summary> The time that a body must be still before it will go to sleep.
        /// </summary>
        public const float b2_timeToSleep = 0.5f;

        /// <summary> A body cannot sleep if its linear velocity is above this tolerance.
        /// </summary>
        public const float b2_linearSleepTolerance = 0.01f;

        /// <summary> A body cannot sleep if its angular velocity is above this tolerance.
        /// </summary>
        public const float b2_angularSleepTolerance = (2.0f / 180.0f * b2_pi);

        /// <summary> Friction mixing law. Feel free to customize this.
        /// </summary>
        ...
        /// <summary> Restitution mixing law. Feel free to customize this.
        /// </summary>
