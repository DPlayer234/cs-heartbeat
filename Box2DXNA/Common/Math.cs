...
namespace Box2D.XNA
{
    public static class MathUtils
    {
        ...
        /// <summary> This function is used to ensure that a floating point number is
        ...
        /// <summary> This is a approximate yet fast inverse square-root.
        /// </summary>
        ...
        /// <summary> A 2-by-2 matrix. Stored in column-major order.
    /// </summary>
    public struct Mat22
    {
	    /// <summary> construct this matrix using columns.
        /// </summary>
	    ...
	    /// <summary> construct this matrix using scalars.
        /// </summary>
	    ...
	    /// <summary> construct this matrix using an angle. This matrix becomes
	    ...
	    /// <summary> Initialize this matrix using columns.
        /// </summary>
	    ...
	    /// <summary> Initialize this matrix using an angle. This matrix becomes
	    /// an orthonormal rotation matrix.
        /// </summary>
	    ...
	    /// <summary> Set this to the identity matrix.
        /// </summary>
	    ...
	    /// <summary> Set this matrix to all zeros.
        /// </summary>
        public void SetZero()
	    {
	    ...
	    /// <summary> Extract the angle from this matrix (assumed to be
	    /// a rotation matrix).
        /// </summary>
    ...
    /// <summary> A transform contains translation and rotation. It is used to represent
    /// the position and orientation of rigid frames.
    /// </summary>
    public struct Transform
    {
	    /// <summary> Initialize using a position vector and a rotation matrix.
        /// </summary>
	    ...
	    /// <summary> Set this to the identity transform.
        /// </summary>
        public void SetIdentity()
	    {
	    ...
	    /// <summary> Calculate the angle that the rotation matrix represents.
        /// </summary>
        public float GetAngle() 
	    {
    ...
    /// <summary> This describes the motion of a body/shape for TOI computation.
    ...
    public struct Sweep
    {
	    ...
	    /// </summary> <param name="alpha"> is a factor in [0,1], where 0 indicates t0.
	    /// </param>
	    ...
	    /// </summary> <param name="t"> the new initial time.
	    /// </param>
